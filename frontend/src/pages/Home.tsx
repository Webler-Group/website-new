        ...
        <>
            ...
            <main className="mainAfterBanner">
                ...
                <div className="rowHome">
                    <div className="col-6">
                        <Link className="linksNoDecor" to="/codeplayground"><h1>Products</h1></Link>
                        ...
                        <div style={{marginTop:"10px", width:"100%", alignItems:"center", display:"flex", justifyContent:"center"}}>
                            <Link style={{textDecoration: "none"}}  to="/codeplayground"><Button style={{marginLeft:"5px", marginRight:"5px"}}>Apps</Button> </Link>
                            <Link style={{textDecoration: "none"}}  to="/codeplayground"><Button style={{marginLeft:"5px", marginRight:"5px"}}>Games</Button></Link>
                            <Link style={{textDecoration: "none"}}  to="/codeplayground"><Button style={{marginLeft:"5px", marginRight:"5px"}}>Other</Button></Link>    
                        </div>
