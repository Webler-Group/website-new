        ...
        <>
            ...
            <main>
                ...
                <div style={{alignSelf:"center", textAlign:"center"}}>
                    <h5>Tell us something we would love to hear.</h5>
                    <p>Your voice is our top priority. Please do not spam.</p>
                </div>
                <div className="form-container d-flex justify-content-center align-items-center" 
                    style={{
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 790 563" fill="none" className="svgContact">
                            <g id="Image">
                                    <g id="g14">
                                            <g id="g16">
                                                    <g id="g22">
                    ...
                    <form className="contactUsform"> {/* <---- Need to define onSubmit event here  */}
                        <div className="form-group position-relative">
                            <label htmlFor="formName" className="d-block">
                                <i className="icon" data-feather="user"></i>
                            </label>
                            <input type="text" id="formName" className="inputTag form-control-lg thick" placeholder="Name" />
                        </div>
                        ...
                        <div className="form-group position-relative">
                            ...
                            <input type="email" id="formEmail" className="inputTag form-control-lg thick" placeholder="E-mail" />
                        </div>

                        <div className="form-group position-relative">
                            <label htmlFor="formSubject" className="d-block">
                                <i className="icon" data-feather="subject"></i>
                            </label>
                            <input type="text" id="formSubject" className="inputTag form-control-lg thick" placeholder="Subject" />
                        </div>

                        <div className="form-group message">
                            <textarea id="formMessage" className="inputTag form-control-lg" rows={7} placeholder="Message" style={{height:"300px"}}></textarea>
                        </div>
                    
                        <div className="text-center">
                            <button type="submit" className="bttn bttn-primary" tabIndex={-1}>Send message</button>
                        </div>
