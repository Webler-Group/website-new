...
const logEvents = (message, logFileName) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (!fs_1.default.existsSync(confg_1.config.logDir)) {
            yield fs_1.default.promises.mkdir(confg_1.config.logDir);
        }
        yield fs_1.default.promises.appendFile(path_1.default.join(confg_1.config.logDir, logFileName), logItem);
    }
    catch (err) {
        console.log(err);
    }
